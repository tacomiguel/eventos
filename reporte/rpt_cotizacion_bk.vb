...
Public Class rpt_cotizacion_bk
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGE_Eventos.rpt_cotizacion_bk.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cotizacion_bk
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cotizacion_bk = New rpt_cotizacion_bk()
        rpt.Site = Me.Site
        Return rpt
    End Function
