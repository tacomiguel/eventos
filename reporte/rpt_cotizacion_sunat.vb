...
Public Class rpt_cotizacion_sunat
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_cotizacion_sunat.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGE_Eventos.rpt_cotizacion_sunat.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cotizacion_sunat
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cotizacion_sunat = New rpt_cotizacion_sunat()
        rpt.Site = Me.Site
        Return rpt
    End Function
