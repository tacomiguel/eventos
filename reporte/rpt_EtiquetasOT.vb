...
Public Class rpt_EtiquetasOT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGE_Eventos.rpt_EtiquetasOT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EtiquetasOT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EtiquetasOT = New rpt_EtiquetasOT()
        rpt.Site = Me.Site
        Return rpt
    End Function
