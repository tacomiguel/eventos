...
Public Class rptBEOEventos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SGE_Eventos.rptBEOEventos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptBEOEventos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptBEOEventos = New rptBEOEventos()
        rpt.Site = Me.Site
        Return rpt
    End Function
